...
#    Updated: 2025/03/27 09:16:24 by mez-zahi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_COMMUN = commun/concat_arg.c commun/creat_pile.c commun/element_comun_1.c\
			commun/element_comun_2.c commun/lis.c commun/push.c commun/rotate.c commun/rrotate.c commun/swap.c \
...
OBJS = $(SRCS:.c=.o)  $(SRCS_COMMUN:.c=.o)
OBJ_BONUS = $(SRCS_BONUS:.c=.o) $(SRCS_COMMUN:.c=.o)
